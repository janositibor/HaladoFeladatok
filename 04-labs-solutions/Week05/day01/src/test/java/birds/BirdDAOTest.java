...
class BirdDAOTest {
    ...
    void testListBirds() {
        ...
        assertThat(expected)
                .hasSize(12)
                .extracting(Bird::getBirdSpecies)
                .contains(BirdSpecies.BLACKBIRD, BirdSpecies.OWL, BirdSpecies.STORK, BirdSpecies.SWALLOW)
                .containsExactly(BirdSpecies.OWL,BirdSpecies.OWL,BirdSpecies.OWL,BirdSpecies.OWL, BirdSpecies.SWALLOW, BirdSpecies.SWALLOW,BirdSpecies.BLACKBIRD,BirdSpecies.BLACKBIRD,BirdSpecies.BLACKBIRD, BirdSpecies.STORK, BirdSpecies.STORK, BirdSpecies.STORK);
    }
